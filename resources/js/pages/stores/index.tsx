      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{stores.filter(store => store.is_active).length}</div>
              <p className="text-xs text-muted-foreground">
                {stores.length > 0 ? 
                  t('{{percent}}% active rate', { percent: Math.round((stores.filter(store => store.is_active).length / stores.length) * 100) }) : 
                  t('No stores yet')}
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{aggregatedStats.formattedRevenue || formatCurrency(0)}</div>
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 mt-1">
                        ...
                        <span className="text-xs text-muted-foreground">{t('{{revenue}} revenue', { revenue: store.formatted_revenue || formatCurrency(0) })}</span>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
