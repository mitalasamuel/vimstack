                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-white/50 rounded-lg p-2 text-center">
                      ...
                      <div className="text-xs text-muted-foreground">{t("Businesses")}</div>
                    </div>
                    <div className="bg-white/50 rounded-lg p-2 text-center">
                    ...
                    <div className="bg-white/50 rounded-lg p-2 text-center">
                      ...
                      <div className="text-xs text-muted-foreground">{t("Bio Links")}</div>
                    </div>
                    <div className="bg-white/50 rounded-lg p-2 text-center">
                      <div className="text-lg font-bold" style={{ color: primaryColor }}>{plan.stats?.bio_links_templates || '14'}</div>
                      <div className="text-xs text-muted-foreground">{t("Bio Templates")}</div>
                    </div>
                  </div>
                </div>
