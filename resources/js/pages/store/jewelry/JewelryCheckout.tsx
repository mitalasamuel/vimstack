                    ...
                    <div>
                      ...
                      <form onSubmit={handleShippingSubmit} className="space-y-8">
                        ...
                        <div className="flex justify-between items-center pt-8">
                          <Link 
                            href={route('store.cart', { storeSlug })}
                    ...
                    <div>
                      ...
                      <div className="space-y-8">
                        ...
                        <div className="pt-8 border-t border-yellow-200">
                          ...
                          <div className="space-y-4">
                            {/* Cash on Delivery */}
                            <div className="bg-white/70 border-2 border-yellow-200 rounded-xl p-6 hover:border-yellow-400 transition-colors">
                              <div className="flex items-center">
                                <input
                                  id="payment-cod"
                                  name="payment-method"
                            ...
                            {Object.entries(enabledPaymentMethods).map(([method, config]: [string, any]) => {
                              ...
                              return (
                                <div key={method} className="border rounded-lg p-4 hover:border-yellow-400 transition-colors">
                                  <div className="flex items-center">
                                    <input
                                      id={`payment-${method}`}
                                      name="payment-method"
                                    ...
                                    />
                                    <label htmlFor={`payment-${method}`} className="ml-3 flex-1 cursor-pointer">
