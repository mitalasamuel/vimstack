...
Route::middleware(['auth', 'verified', 'plan.access'])->group(function () {
    ...
    Route::get('settings', [SettingsController::class, 'index'])
        ->middleware('role_or_permission:superadmin|manage-settings|manage-system-settings|manage-email-settings|manage-brand-settings|manage-company-settings|manage-storage-settings|manage-payment-settings|manage-currency-settings|manage-recaptcha-settings|manage-chatgpt-settings|manage-cookie-settings|manage-seo-settings|manage-cache-settings|manage-account-settings|manage-webhook-settings')
        ->name('settings');
