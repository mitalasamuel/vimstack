...
class LandingPageSeeder extends Seeder
{
    ...
    {
        // Force update with new realistic stats data
        $existingStats = null;
                ...
                'sections' => [
                    ...
                    [
                        ...
                        'stats' => [
                            ...
                            ['label' => 'Payment Gateways', 'value' => '30+', 'color' => '#10b981'],
                    ...
                    [
                        ...
                        'trust_stats' => [
                            ['value' => '98.5%', 'label' => 'Customer Satisfaction', 'color' => '#10b981'],
        ...
        $this->command->info('Landing page settings and custom pages created successfully.');
    }
}